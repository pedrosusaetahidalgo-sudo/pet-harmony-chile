-- =====================================================
-- Fix: get_medical_summary_data references sp.business_name
-- which does not exist in service_providers (correct column
-- is display_name). This causes 500 on generate-medical-summary
-- edge function — the crown jewel PDF feature.
-- =====================================================
...
COMMENT ON FUNCTION public.get_medical_summary_data(UUID)
  IS 'v3.1: Fix sp.business_name -> sp.display_name (column did not exist in service_providers)';
