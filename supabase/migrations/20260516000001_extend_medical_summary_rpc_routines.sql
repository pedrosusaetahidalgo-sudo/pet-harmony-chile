-- =====================================================
-- Extend get_medical_summary_data to support mode parameter.
-- mode='medical' (default): same as before
-- mode='complete': includes routines data for full PDF
-- =====================================================
...
BEGIN
  ...
  -- If mode is 'complete', add routines
...
COMMENT ON FUNCTION public.get_medical_summary_data(UUID, TEXT)
  IS 'v4: Supports mode parameter (medical/complete). Complete mode includes active routines.';
