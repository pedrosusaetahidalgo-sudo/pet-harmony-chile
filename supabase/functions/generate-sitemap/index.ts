...
const COMUNAS = [
  "las-condes", "vitacura", "lo-barnechea", "providencia", "nunoa",
  "la-reina", "macul", "penalolen", "santiago", "independencia",
  "recoleta", "san-miguel", "la-florida", "maipu", "puente-alto",
  "quilicura", "huechuraba", "estacion-central",
];

const ESPECIALIDADES = [
  "medicina-general", "cirugia", "dermatologia", "oftalmologia",
  "cardiologia", "oncologia", "geriatria", "comportamiento-animal",
  "animales-exoticos", "reproduccion", "odontologia", "neurologia",
  "ortopedia", "vacunacion", "esterilizacion",
];
