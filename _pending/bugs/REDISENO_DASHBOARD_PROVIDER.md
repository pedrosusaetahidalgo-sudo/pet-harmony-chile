...
>
> ### IMPORTANTE — Contexto actualizado (2026-04-29)
> El diagnostico de la seccion 1 (queries contra tablas vacias) **ya fue corregido**.
> - `ProviderDashboard.tsx` ya NO consulta `provider_balances`, `order_items` ni `orders`
> - Todo el data fetching se delega a `useProviderDashboardStats.ts` que consulta solo tablas vivas: `service_providers`, `vet_clinical_notes`, `medical_share_tokens`, `vet_bookings`, `service_reviews`, `review_invitations`
> - El dashboard ya renderiza `MetricCard`, `ProviderDirectoryCard`, `SharedFichasCard`, `VetFollowupsCard`, `VetPatientsList`, `CreateServicePromotion`
> - El voseo argentino fue corregido en commit `939576e`
>
> ### Que queda pendiente de este blueprint
> - Fases 2-3: tendencias con sparklines, tabs de actividad reciente (Pacientes/Reservas/Resenas)
> - Fase 4: campos expandidos de perfil (horarios, redes sociales, metodos de pago, idiomas)
> - Fase 5: verificacion Colmevet
> - Fase 6: tracking avanzado de vistas
> - Estados adaptativos del dashboard (onboarding / early traction / active practice)
