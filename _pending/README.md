...
|---|---|---|---|---|---|
| 1 | [MASTER_UPGRADE_2026_04.md](MASTER_UPGRADE_2026_04.md) | Plan orquestador | 🟠 Media | **Cerca del cierre total** — FASE 0-6 cerradas (commits `44c0fb3`, `490b29b`), FASE 7.1 cerrada (migración `20260427000004`), **FASE 0.2/0.3/0.4 cerradas 2026-04-12**, **FASE 7.2 cerrada 2026-04-12 (4 saved queries en Supabase Studio)**. Solo queda **FASE 8 (docs vivas — mayormente cerrada en commit `7040db5`, pendiente barrido final)**. | — |
