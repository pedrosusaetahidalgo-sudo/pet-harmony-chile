...
|---|---|---|---|---|---|
| 1 | [MASTER_UPGRADE_2026_04.md](MASTER_UPGRADE_2026_04.md) | Plan orquestador | 🔴 Alta | Parcial — FASE 0-6 cerradas (commits `44c0fb3`, `490b29b`), FASE 7.1 cerrada (migración `20260427000004`), **FASE 0.2 cerrada 2026-04-12 (Google OAuth branding aplicado en proyecto 811742672720, validado en incógnito)**, **FASE 0.3 cerrada 2026-04-12 (HTTPS activo en GH Pages, 301 redirect verificado)**, **FASE 0.4 cerrada 2026-04-12 (seed contamination en perfil vet — código ya filtraba por `user_id`, auditoría SQL retroactiva corrida con 0 filas)**. Quedan: FASE 7.2 (queries savadas en Studio), FASE 8 (docs vivas) | — |
