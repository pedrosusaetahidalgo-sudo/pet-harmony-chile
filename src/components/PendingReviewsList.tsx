...
const PendingReviewsList = () => {
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps -- loadPendingReviews depends on user from closure; listed deps are sufficient
  }, [user]);
          ...
          <div className="space-y-2">
            {pendingBookings.slice(0, 3).map((booking) => (
              ...
              >
                ...
                <Button size="sm" onClick={() => setSelectedBooking(booking)} className="gap-1">
