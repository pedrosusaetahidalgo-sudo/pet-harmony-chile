...
// E.1 auditoria top-tier 2026-04-20: constantes, helpers y componentes
// reutilizables extraidos a modulos separados bajo ./salaInversion/.
import {
  TARGETS_90D,
  PAID_PROVIDER_PLANS,
...
import {
  ...
  loadFinancing,
  saveFinancing,
} from './salaInversion/helpers';
import { LightTooltip, MetaRow, KpiCard } from './salaInversion/shared';
import {
  Trophy,
  Target,
  Users,
...
// (Constantes y helpers extraidos a ./salaInversion/ — E.1 2026-04-20)
