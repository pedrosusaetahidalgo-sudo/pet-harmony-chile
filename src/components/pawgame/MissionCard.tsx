...
export const MissionCard = ({
  ...
  return (
    <Card
      className={`relative overflow-hidden transition-all hover:shadow-lg ${isLocked ? 'opacity-60' : ''} ${isCompleted ? 'ring-2 ring-green-500' : ''}`}
    >
      ...
      <CardContent className="p-4">
        <div className="flex items-start gap-3">
          <div
            className={`p-3 rounded-xl bg-gradient-to-br ${getCategoryColor(mission.category)} flex-shrink-0`}
          >
            {isLocked ? (
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-1">
              ...
              {isCompleted && (
                <Badge className="bg-green-500/10 text-green-600 text-[10px]">✓ Completada</Badge>
              )}
            </div>
