    ...
    return (
      ...
      >
        ...
        <CardContent className="p-4 text-center">
          <div
            className={`w-14 h-14 mx-auto mb-3 rounded-full bg-gradient-to-br ${getRarityColor(badge.rarity)} flex items-center justify-center shadow-lg`}
          >
            {isEarned ? (
          ...
          <p className="text-[10px] text-muted-foreground line-clamp-2 mb-2">{badge.description}</p>
