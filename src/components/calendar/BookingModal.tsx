          ...
          <div className="space-y-4">
            <div className="bg-muted/50 p-3 rounded-lg text-sm space-y-1">
              ...
              <p className="text-muted-foreground">
                {slot.slot_date} — {slot.start_time?.slice(0, 5)} a {slot.end_time?.slice(0, 5)}
              </p>
            </div>

            {pets && pets.length > 0 && (
              <div>
                <label htmlFor="booking-pet" className="text-sm font-medium mb-1.5 block">
                  Mascota
                </label>
            ...
            <div>
              <label htmlFor="booking-notes" className="text-sm font-medium mb-1.5 block">
                Notas (opcional)
              </label>
              <Textarea
                id="booking-notes"
