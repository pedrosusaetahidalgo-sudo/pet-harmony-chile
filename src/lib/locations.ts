...
export const COMUNA_COORDS: Record<ComunaSantiago, [number, number]> = {
  ...
  Conchalí: [-33.3811, -70.675],
  'El Bosque': [-33.5614, -70.675],
...
/**
 * Comunas + opción "Otra comuna" para dropdowns.
 * Usar esto en formularios en vez de COMUNAS_SANTIAGO directo.
 */
export const COMUNAS_DROPDOWN = [...COMUNAS_SANTIAGO, 'Otra comuna'] as const;
