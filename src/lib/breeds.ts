...
export const BREEDS_BY_SPECIES: Record<string, BreedOption[]> = {
  perro: [
    ...
    { value: 'pastor_suizo', label: 'Pastor suizo' },
    { value: 'pastor_holandes', label: 'Pastor holandés' },
  ...
  gato: [
    ...
    { value: 'atigrado', label: 'Atigrado / Tabby' },
    { value: 'tricolor', label: 'Tricolor / Calicó' },
    { value: 'blanco_y_negro', label: 'Blanco y negro / Smoking' },
  ],
  conejo: [
    { value: 'mestizo', label: 'Mestizo' },
