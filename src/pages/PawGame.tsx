...
const PawGame = () => {
  ...
  const quickActions = [
    ...
    { title: "Vacunar", icon: Syringe, href: "/medical-records", color: "from-purple-600 to-teal-500", points: "+50 pts" },
    { title: "Socializar", icon: Users, href: "/feed", color: "from-purple-500 to-pink-500", points: "+20 pts" },
