    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <main className="container mx-auto px-4 py-8 max-w-2xl">
        ...
        <div className="mt-6 p-3 bg-amber-50 border border-amber-200 rounded-lg text-xs text-amber-900">
          ...
          venta. No está linkeada desde la navegación pública. Los 5 perfiles tienen datos ficticios
          marcados con <code>license_number LIKE 'DEMO%'</code> para identificarlos en la base de
          datos.
        </div>
      </main>
