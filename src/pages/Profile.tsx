      ...
      <Tabs defaultValue="posts" className="w-full">
                  ...
                  <CardContent className="p-0">
                    <div className="relative aspect-square overflow-hidden">
                      <img
                        src={
                          pet.photo_url ||
                          (pet.species === "perro" ? dogProfile : catProfile)
                        }
                        alt={pet.name}
        ...
        <TabsContent value="achievements" className="mt-6">
          <div className="space-y-6">
            ...
            {/* Button to see all gamification */}
            <Button
              className="w-full bg-warm-gradient hover:opacity-90 text-sm"
              onClick={() => navigate("/gamification")}
            >
              Ver Todos los Logros y Desafíos
            </Button>
          </div>
        </TabsContent>
