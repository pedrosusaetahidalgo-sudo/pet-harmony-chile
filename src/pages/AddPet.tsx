    ...
    return (
      <div className="container px-4 py-12 max-w-xl mx-auto animate-fade-in">
        <PremiumGate
          ...
          description={`Tu plan gratis incluye 2 mascotas. Con Paw Member sumás 4 mascotas, Paw Passport PDF, Insights Pro, Audio IA, reportes históricos y descuentos Paw Partners. Manada permite 5 mascotas + soporte prioritario + aporte refugios.`}
        >
