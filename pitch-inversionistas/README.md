...
| Mes | Accion |
|---|---|
| **Mes 0 (pre-launch)** | Outreach a 13 refugios chilenos (en curso). Definir SpA Flow (en curso). Paw Shield (biometría vía Petify) queda en roadmap futuro · pausada hoy, código dormido en repo, reactivable solo si entra un partner B2B (ej. aseguradora) que financie el COGS. |
